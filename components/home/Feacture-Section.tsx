...
const FeactureSection = () => {
  return (
    <section className="py-12 bg-white text-black sm:py-12 lg:py-16">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center xl:max-w-2xl">
            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl xl:text-5xl mb-6">We are just
                getting started!</h2>
        ...
        <div
            ...
            <div className="relative">
                ...
                <div className="relative overflow-hidden bg-white shadow-md rounded-xl h-full hover:scale-105 transition ease-in-out duration-200">
            ...
            <div className="overflow-hidden bg-white shadow-md rounded-xl hover:scale-105 transition ease-in-out duration-200">
